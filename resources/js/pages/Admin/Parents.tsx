                        ...
                        <div className="space-y-4">
                            ...
                            <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                                <p className="text-sm text-blue-700 dark:text-blue-300">
                                    <strong>Note:</strong> Password will be automatically generated and sent to the parent's email address.
                                </p>
                            </div>
                                                ...
                                                <td className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 whitespace-nowrap text-right">
                                                    <div className="flex justify-end space-x-1 sm:space-x-2">
                                                        ...
                                                        <button
                                                            ...
                                                            className={`p-1.5 sm:p-2 ${TEXT_COLOR_CLASS} dark:text-blue-400 ${LIGHT_HOVER_CLASS} dark:hover:bg-gray-700 rounded-lg transition-colors`}
                                                            title="Edit Guardian"
                                                        >
