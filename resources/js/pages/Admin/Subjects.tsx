                    ...
                    <div className="p-6 dark:bg-gray-800">
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p className="text-gray-900 dark:text-white font-medium mt-1">₱{subject.price ? Number(subject.price).toFixed(2) : 'N/A'}</p>
                            </div>
                            {subject.description && (
                                    ...
                                    {loading ? (
                                        ...
                                        subjects.map((subject) => (
                                            <tr key={subject.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                                ...
                                                <td className="hidden md:table-cell px-3 sm:px-4 md:px-6 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm text-gray-700 dark:text-gray-300">₱{subject.price ? Number(subject.price).toFixed(2) : 'N/A'}</td>
