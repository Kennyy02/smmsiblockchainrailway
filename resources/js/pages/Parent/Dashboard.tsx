                ...
                <div className="container mx-auto px-3 sm:px-4 md:px-6 py-4 sm:py-6 md:py-8">
                    ...
                    <div className="mb-4 sm:mb-6 md:mb-8 flex flex-col md:flex-row md:items-center md:justify-between">
                        <div className="mb-4 sm:mb-6 md:mb-0">
                            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-1 sm:mb-2">Parent Dashboard</h1>
                            {user && parent && (
                        ...
                        <div className="bg-white dark:bg-gray-800 dark:border-gray-700 rounded-xl sm:rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 sm:p-6 mb-4 sm:mb-6 md:mb-8">
                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0">
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white">{parent.full_name}</h2>
                                        <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">{parent.email}</p>
                                    </div>
                                </div>
                                <div className="text-left sm:text-right">
                                    <p className="text-xs text-gray-400 dark:text-gray-500 uppercase tracking-wide mb-1">Linked Children</p>
                                    <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">{children.length}</p>
                                </div>
                            </div>
                        </div>
                    )}
                    ...
                    {loading && !notification ? (
                        ...
                        <>
                            ...
                            {stats.children.length > 1 && (
                                <div className="bg-white dark:bg-gray-800 dark:border-gray-700 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 border border-gray-100 dark:border-gray-700 mb-4 sm:mb-6 md:mb-8">
                                    <h2 className={`text-lg sm:text-xl font-bold ${TEXT_COLOR_CLASS} flex items-center mb-3 sm:mb-4`}>
